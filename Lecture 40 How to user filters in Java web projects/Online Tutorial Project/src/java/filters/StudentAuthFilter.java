...
public class StudentAuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (user != null && ("teacher".equals(user.getType())|"admin".equals(user.getType())|"student".equals(user.getType()))) {  
            chain.doFilter(request, response);  // Allow the request to proceed if the user is a Teacher or Admin or Student.
        } else {
